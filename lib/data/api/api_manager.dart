...
import '../../ui/utils/my_shared_preferences.dart';
import '../models_dto/request/login_requsest_dto.dart';
import '../models_dto/request/register_request_dto.dart';
import '../models_dto/response/add_to_cart_response_dto.dart';
import '../models_dto/response/add_to_wishlist_response_dto.dart';
import '../models_dto/response/categories_brands_response_dto.dart';
import '../models_dto/response/get_cart_response_dto.dart';
import '../models_dto/response/get_wishlist_response_dto.dart';
import '../models_dto/response/products_response_dto.dart';
import '../models_dto/response/register_response_dto.dart';
...
class ApiManager {
  ...
  Future<Either<Errors, AddToWishListResponseDTO>> addToWishList(
      String? productId) async {
    final List<ConnectivityResult> connectivityResult =
        await (Connectivity().checkConnectivity());
  ...
  Future<Either<Errors, AddToWishListResponseDTO>> removeFromWishList(
      String? productId) async {
    final List<ConnectivityResult> connectivityResult =
        await (Connectivity().checkConnectivity());
